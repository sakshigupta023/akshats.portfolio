...
const projectDataHub = {
    'protocol-72': {
        meta: 'Movie Poster · Key Art · Action Thriller',
        title: 'Protocol 72: Codename Bharat',
        desc: 'Cinematic key art for a high-stakes spy-thriller audio series. Layered VFX elements — drones, wanted-board overlays, laser-sight silhouettes and dramatic rim lighting — were composited to sell blockbuster scale on a single static frame.',
        tags: ['Photoshop', 'Midjourney', 'Key Art'],
        imgSrc: 'assets/work-real/protocol-72-codename-bharat.jpg'
    },
    'khatu-shyam': {
        meta: 'Mythology · Devotional Campaign',
        title: 'Khatu Shyam — Haare Ka Sahara',
        desc: 'Epic mythological cover art blending devotional symbolism with battlefield scale. Built through custom Gen-AI image workflows and hand-finished compositing to land an emotional, festival-ready tone for a devotional audio drama.',
        tags: ['Midjourney', 'ChatGPT AI', 'Visual Storytelling'],
        imgSrc: 'assets/work-real/khatu-shyam-hare-ka-sahara.jpg'
    },
    'horror-bhakti': {
        meta: 'Campaign · Horror Aesthetic',
        title: 'Horror Ya Bhakti',
        desc: 'A moody dual-genre campaign visual pitting horror against devotion, built to drive sign-ups across seven simultaneous writing contests with a single thumb-stopping composition.',
        tags: ['Photoshop', 'Color Grading', 'Campaign Layout'],
        imgSrc: 'assets/work-real/horror-ya-bhakti-contests.jpg'
    },
    'adaptation-contest': {
        meta: 'Community Engagement · Contest Banner',
        title: 'Adaptation Contest — ₹1 Lakh Prize Pool',
        desc: 'Jungle-adventure key art built to launch a high-value writing contest, using cinematic torchlight and character staging to make the prize pool feel like a movie release rather than a form submission.',
        tags: ['Creative Direction', 'AI Workflows', 'Brand Identity'],
        imgSrc: 'assets/work-real/9-adaptation-contest-live.jpg'
    },
    'milestone-50k': {
        meta: 'Community · Illustrative Character',
        title: '10K पर रुकना नहीं',
        desc: 'A playful illustrated character concept used to nudge writers toward consistency — translating a dry growth metric (word count milestones) into a fun, scroll-stopping narrative moment.',
        tags: ['Illustrator', 'AI Workflows', 'Creative Direction'],
        imgSrc: 'assets/work-real/milestone-50k-consistency.jpg'
    }
};
